...
function createInfoContainer() {
    ...
    bioSpan.innerText = `
        Founded in October of 2007, Mike's Cereal Shack has been offering every brand of cereal you can imagine. 

        Our mission has always been clear: to offer every type of cereal you can buy in the store, but in a more social setting. 
        
        If you are tired of your friends and family avoiding your calls and declining your 
        social invitations, then Mike's Cereal Shack is the place for you. 
        
        Come enjoy a bowl at one of our family-style tables. Or sit at the high tops where you  
        can share and bond with other like-minded cereal-lovers. 
        
        All are welcome at Mike's Cereal Shack!
    `;
